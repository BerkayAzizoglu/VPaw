...
const styles = StyleSheet.create({
  ...
  topTint: {
    ...
    right: 0,
    height: 220,
    backgroundColor: 'rgba(247, 241, 232, 0.72)',
  },
  sheet: {
    flex: 1,
    marginTop: 72,
  ...
  iconBtn: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(232, 224, 213, 0.95)',
    alignItems: 'center',
  ...
  groupCard: {
    ...
    borderRadius: 28,
    borderWidth: 1,
    borderColor: 'rgba(235, 226, 214, 0.96)',
    padding: 16,
    overflow: 'hidden',
    shadowColor: '#9d8567',
    shadowOpacity: 0.05,
  ...
  input: {
    ...
    borderRadius: 14,
    borderWidth: 1,
    borderColor: 'rgba(223, 214, 203, 0.98)',
  ...
  avatarOptionWrap: {
    ...
    borderRadius: 28,
    borderWidth: 1.5,
    borderColor: 'rgba(231, 222, 210, 0.96)',
    padding: 3,
